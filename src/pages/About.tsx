    ...
    <div className="pt-20">
      ...
      <section className="relative py-24 bg-[#1F85A8]">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <span className="text-blue-400 font-semibold text-sm tracking-widest uppercase">{pageContent.hero?.eyebrow}</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1F85A8] mb-6">{pageContent.intro?.title}</h2>
